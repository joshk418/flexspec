...
status: todo
satisfies: [FR-006, FR-007, FR-008, FR-009, NF-004, NF-005]
depends_on: [T-004]
verified_by: [TC-006]
---
...
> **Satisfies**: FR-006, FR-007, FR-008, FR-009, NF-004, NF-005 · **Depends on**: T-004 · **Verified by**: TC-006

## Objective

Create `flexspec-glossary-discovery`, a skill that scans project language, asks about unclear terms, and writes confirmed definitions through the CLI.
